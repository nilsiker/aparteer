...
signal transition_started(to_level_path: String, from_level_path: String)
...
func transition(to_level_path: String, from_level_path: String) -> void:
	transition_started.emit(to_level_path, from_level_path)
